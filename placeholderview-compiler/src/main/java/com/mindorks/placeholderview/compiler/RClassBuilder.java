...
public final class RClassBuilder {
    ...
    private static ClassName className = ClassName.get(NameStore.Package.R, NameStore.Class.R);
    private Filer filer;
    ...
    public String addLayoutId(TypeElement element, int layoutId) {
        ...
        if (layoutNameAndIdMap.containsKey(variable)) {
            return variable;
        }
    ...
    public String addViewId(VariableElement element, int viewId) {
        int count = 0;
        String variable = element.getSimpleName().toString();
        ...
        idClassBuilder.addField(FieldSpec.builder(int.class, variable)
                ...
                .build());
        layoutNameAndIdMap.put(variable, viewId);
        return variable;
    }

    public RClassBuilder build() {
        classBuilder
